...
ocr = PaddleOCR(
    ...
    text_recognition_model_dir="/media/anhlbt/SSD2/workspace/OCR/PaddleOCR/output/PP-OCRv5_server_rec_a0_infer",
...
# ocr = PaddleOCR(
result = ocr.predict("/media/anhlbt/AnhLBT/DATASET/paddleocr/dataset/41.jpg")
for res in result:
    res.print()
